...
const gameControllers = __importStar(require("@/controllers/gameController"));
...
describe('gameRoutes', () => {
    ...
    it('should returns games list correctly', () => __awaiter(void 0, void 0, void 0, function* () {
        const response = yield (0, supertest_1.default)(app).get('/api/games/list');
