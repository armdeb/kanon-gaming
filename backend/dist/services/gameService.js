...
function readGameData() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            const dataPath = path_1.default.join(__dirname, '../../data/game-data.json');
            const data = yield promises_1.default.readFile(dataPath, 'utf8');
 ...
 */
const fetchGames = (search) => __awaiter(void 0, void 0, void 0, function* () {
    const games = yield readGameData();
    if (!search) {
        return games;
    }
