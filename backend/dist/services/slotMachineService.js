...
exports.calculateWinnings = exports.spinReels = void 0;
 ...
 */
function calculateWinnings(spins) {
    var _a, _b;
    if (spins.length !== 3) {
        ...
        // apple, apple, apple
        return ((_a = rewards[spins[0]]) === null || _a === void 0 ? void 0 : _a[3]) || 0;
    }
    else if (spins[0] === spins[1] || spins[1] === spins[2]) {
        // apple, apple, lemon or lemon, apple, apple
        return ((_b = rewards[spins[1]]) === null || _b === void 0 ? void 0 : _b[2]) || 0;
    }
    else {
        // no same
        return 0;
